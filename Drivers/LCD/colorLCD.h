...
#define LCD_SD_PIN BIT7 //MOSI
#define LCD_SD_PORT P1OUT
#define LCD_SD_PORT_IN P1IN
#define LCD_SD_DIR P1DIR

#define LCD_SCE_PIN BIT1 // CS
#define LCD_SCE_PORT P2OUT
#define LCD_SCE_SETUP P2DIR

#define LCD_DC_PIN BIT0	//RS
#define LCD_DC_PORT P2OUT
#define LCD_DC_SETUP P2DIR

#define LCD_BLIGHT BIT2
#define LCD_BLIGHT_OUTPUT P2OUT
#define LCD_BLIGHT_SETUP P2DIR

#define LCD_BLIGHT_OFF LCD_BLIGHT_OUTPUT &=~LCD_BLIGHT
#define LCD_BLIGHT_ON LCD_BLIGHT_SETUP |= LCD_BLIGHT; LCD_BLIGHT_OUTPUT |=LCD_BLIGHT
